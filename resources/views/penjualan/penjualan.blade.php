        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center pt-3">
                    <div class="btn-group">
                        <!-- ✅ Tombol Hapus diganti jadi form -->
                        <form action="{{ url("/penjualan/hapus/$item->id_penjualan") }}" method="POST" onsubmit="return confirm('Apakah anda yakin ingin menghapus katalog tersebut?');" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-sm btn-outline-danger">Delete</button>
                        </form>

                        <a href="{{ url("/penjualan/$item->id_penjualan") }}">
