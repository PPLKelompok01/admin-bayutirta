...
@section('content')
          ...
          <div class="item">
            <div class="icon"><svg width="57" height="56" viewBox="0 0 57 56" fill="none"
              ...
              <clipPath id="clip0_23_1500">
                <rect width="32.8417" height="32.8417" fill="white" transform="translate(11.7266 11.7242)" />
              </clipPath>
              </defs>
            </svg>
  ...
  @endif
      ...
      <button data-item="{{json_encode($item)}}" id="konfirmasi" type="button" class="btn confirm"
      data-bs-toggle="modal" data-bs-target="#modalkonfirmasi-{{$item->id_reservasi}}">Beri
      Konfirmasi</button>

      <div class="modal fade" id="modalkonfirmasi-{{$item->id_reservasi}}" tabindex="-1"
      ...
      placeholder="Tulis keterangan untuk pelanggan jika permohonan ditolak"
    ...
    @endif
      ...
      <a class="confirm-detail" type="button" data-item="{{json_encode($item)}}" data-bs-toggle="modal"
      data-bs-target="#modalDetail-{{$item->id_reservasi}}"><svg width="14" height="14" viewBox="0 0 14 14"
      ...
      <a class="menu-detail" type="button" data-item="{{json_encode($item)}}" data-bs-toggle="modal"
      data-bs-target="#modalEdit-{{$item->id_reservasi}}">
      ...
      <!-- Modal Detail -->
      <div class="modal fade" id="modalDetail-{{$item->id_reservasi}}" tabindex="-1"
      aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
      <div class="modal-content">
      <div class="modal-header">
      ...
      <!-- End -->
      <!-- Modal Edit -->
      <div class="modal fade" id="modalEdit-{{$item->id_reservasi}}" tabindex="-1"
      aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
      <div class="modal-content">
      <div class="modal-header">
    ...
    <div class="desc">
      ...
      <button type="button" class="btn confirm" data-bs-toggle="modal" data-bs-target="#exampleModal">Beri
      Konfirmasi</button>
